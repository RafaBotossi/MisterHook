...
Namespace Playback
    ...
    Public Class PlaybackActions
        ...
        Private _ActionStructs As List(Of Object) 'Ações de Teclado ou Mouse em ordem cronológica
        Private _StopPlayback As Boolean 'Se é necessário dar Stop no Playback

        Private WithEvents KeyboardRecorder As Record.KeyboardRecorder 'Usamos uma gravação de teclas para verificar se a pessoa clicou na tecla Pause para parar a gravação
        ...
        Public Sub Playback(Optional PathAndFilename As String = "")
            ...
            If _ActionStructs IsNot Nothing AndAlso _ActionStructs.Count > 0 Then
                ...
                KeyboardRecorder = New Record.KeyboardRecorder(_HInstance)
